import { findAllUsers, findSpecificUser, addUserToDB ,GetUserByEmail,DeleteUserFromDB,UpdateUserFromDB,AddVehicle,AddCard,RemoveCard,AddToHistory,RemoveVehicles,AddChat} from "./user.db.js";
export  default class User
{
    constructor(firstname,lastname,email,password,admin=false,history=[],vehicles=[],card={},chat=[])
 {
